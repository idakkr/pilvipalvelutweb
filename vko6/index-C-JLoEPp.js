 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Hn(xS,VS,"app");const jv={apiKey:"AIzaSyCxINnslfRE_XVw0z5SCnb2yXn4b-PE03o",authDomain:"pilvipalvelut-6cd6b.firebaseapp.com",projectId:"pilvipalvelut-6cd6b",storageBucket:"pilvipalvelut-6cd6b.firebasestorage.app",messagingSenderId:"1031892986058",appId:"1:1031892986058:web:7704501acab42e19b12c33"};function MS(){const t=Wh(jv),e=OS(t),[n,r]=Ot.useState(""),[i,s]=Ot.useState(""),a=async l=>{l.preventDefault();try{await _1(e,n,i).then(u=>{const d=u.user;console.log("Tämä on esimerkkiviesti "+d.email)})}catch{}};return J.jsx("div",{children:J.jsxs("form",{onSubmit:a,children:[J.jsxs("div",{children:[J.jsx("label",{htmlFor:"email",children:"Sähköposti:"}),J.jsx("input",{type:"email",id:"email",value:n,onChange:l=>r(l.target.value),required:!0})]}),J.jsxs("div",{children:[J.jsx("label",{htmlFor:"password",children:"Salasana:"}),J.jsx("input",{type:"password",id:"password",value:i,onChange:l=>s(l.target.value),required:!0})]}),J.jsx("button",{type:"submit",children:"Kirjaudu sisään"})]})})}const FS="./react-CHdo91hT.svg",US="./vite.svg";var sm=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
